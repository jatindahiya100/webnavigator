    ...
    return (
        <div className="container mx-auto px-4 sm:px-0">
            <div className="border-2 rounded-lg p-6">
                ...
                <p className='text-center text-slate-500' data-aos="fade-up" data-aos-anchor-placement="bottom-bottom">We're proud to share our achievements in serving clients, completing projects, and growing our dedicated team.</p>
