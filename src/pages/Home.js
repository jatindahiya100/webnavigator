  ...
  const gridData = [
    {
      CustomComponent: {
        ...
        description: "This is the first custom component with props.",
        buttonText: "Click Me Now",
        onClick: () => { alert("hi from CustomComponent 1") },
      },
      MediaComponent: {
        mediaType: "lottie",
        lottieOptions: {
    ...
    },
    {
      CustomComponent: {
        ...
        description: "This is the second custom component with props.",
        buttonText: "Click Me Now",
        onClick: () => { alert("hi from CustomComponent 2") },
      },
      MediaComponent: {
        mediaType: "lottie",
        lottieOptions: {
    ...
    // Add more objects as needed for additional components
  ];
